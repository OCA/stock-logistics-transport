...
class TestShipmentAdviceCashOnDelivery(Common):
    ...
    def test01(self):
        """
        Create 1 SO with payment terms cash on delivery for partner without
    ...
    def test02(self):
        """
        Create 1 SO with payment terms cash on delivery for partner with
        invoicing at shipping
        => Should be listed in picking.cash_on_delivery_invoice_ids
        """
        pick, shipment = self._create_and_process_sale_order(
    ...
    def test03(self):
        """
        Create 1 SO without payment terms cash on delivery for partner with
        invoicing at shipping
    ...
    def test04(self):
        """
        Create 1 SO without payment terms cash on delivery for partner without
        invoicing at shipping
        => Should NOT be listed in picking.cash_on_delivery_invoice_ids
        """
        pick, dummy = self._create_and_process_sale_order(
