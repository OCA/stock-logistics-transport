...
class TestCosanumAccountInvoiceAutoComplete(Common):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_select_shipment_with_two_suppliers(self):
        ...
        self._plan_records_in_shipment(self.shipment, self.purchase_2.picking_ids)
    ...
    def test_select_shipment_with_one_supplier(self):
        ...
        self._check_invoiced_lines(invoice, self.purchase_1.picking_ids)
        self.assertTrue(self.shipment.is_invoiced)
