...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:76c0cb967464d29695016e35f319048015f87ce42783f5fd421fd9da47475588
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
Open the *Documents* menu under *TMS > Documents*. Click *Create* and
fill in:

- **Document type**: e.g. driver license, vehicle insurance, inspection.
- **Number / reference**: the reference printed on the document.
- **Holder model** and **Holder ID** (or the *Holder* reference): the
  TMS resource the document belongs to (e.g. a driver or a vehicle).
...
one place. Documents are always created from the *Documents* menu —
there is no button on the driver or vehicle form that creates or
pre-fills them.
